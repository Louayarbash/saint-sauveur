...
//import { InviteModal } from './building/invite/invite.modal';
...
const firebaseRoutes: Routes = [
  {
    path: '',
    loadChildren: () => import('./church/details/details.module').then(m => m.BuildingDetailsPageModule)
  },
  {
    path: 'listing',
  ...
  {
    path: 'invite',
    loadChildren: () => import('./church/invite/invite.module').then(m => m.InvitePageModule)
  }
];
