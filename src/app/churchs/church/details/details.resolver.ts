...
export class BuildingDetailsResolver implements Resolve<any> {
  ...
  resolve(route: ActivatedRouteSnapshot) {
    ...
    const combinedUserDataSource: Observable<BuildingModel/*FirebaseCombinedUserModel*/> = this.firebaseService
    .getCombinedItemDataSource(itemId);

     const combinedUserDataStore: DataStore<BuildingModel> = this.firebaseService
